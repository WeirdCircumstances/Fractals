...
void setup() {
  ...
  //neue Befehle
  background(0);  // Hintergrund auf weiß setzen
  //size(~,~) siehe <public void settings()>
  stroke(255); // Strichfarbe auf schwarz setzen
...
void mouseClicked() {
  ...
  len = len/2; // Länge wird nach jedem Schritt durch drei teilt
